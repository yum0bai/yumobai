...
$.ajax({
    ...
    data: {
        key: 'CU5BZ-3LA64-YHDUO-FNV77-S2ZLF-DVFVO',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(119.65344 , 29.08464, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
